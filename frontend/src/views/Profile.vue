        ...
        <el-dialog v-model="editDialogVisible" title="编辑资料" width="480px" destroy-on-close>
            <el-form :model="editForm" label-position="top">
                ...
                <el-form-item label="院系">
                    <el-select v-model="editForm.department" placeholder="选择或输入院系" filterable allow-create
                        default-first-option clearable style="width: 100%">
                        <el-option v-for="dept in departmentOptions" :key="dept" :label="dept" :value="dept" />
                    </el-select>
                </el-form-item>
                <el-form-item label="年级">
                    <el-select v-model="editForm.grade" placeholder="选择或输入年级" filterable allow-create
                        default-first-option clearable style="width: 100%">
...
const departmentOptions = [
    '计算机学院', '软件学院', '信息科学与工程学院', '电子工程学院', '通信工程学院',
    '经济管理学院', '人文学院', '外国语学院', '法学院', '马克思主义学院',
    '理学院', '材料科学与工程学院', '机械工程学院', '自动化学院', '生命科学与技术学院',
    '环境与化学工程学院', '建筑与城市规划学院', '设计艺术学院', '体育学院', '继续教育学院',
    '其他'
]
